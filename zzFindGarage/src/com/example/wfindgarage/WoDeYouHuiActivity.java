...
public class WoDeYouHuiActivity extends BaseActivity {
	...
	private ArrayList<Data> mDataList_origin=new ArrayList<WoDeYouHuiActivity.Data>();
	private ArrayList<Data> mDataList=new ArrayList<WoDeYouHuiActivity.Data>();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.wodeyouhui);
...
params.addBodyParameter(nameValuePairs);
   ...
   http.send(HttpRequest.HttpMethod.POST,
  		 "http://josie.i3.com.hk/FG/json/m_sale.php",
           params,
				...
				public void onSuccess(ResponseInfo<String> arg0) {
					...
					try {
						 ...
						 if (num_code==1) {
							 ...
							 JSONArray array = jsonObject.getJSONArray("data");
							  for (int i = 0; i < array.length(); i++) {
								 ...
								 data.StreetName = jsonObject2.getString("SaleRemark");
						...
						//new Dialog_noInternet(SaleActivity.this).show();
							 Toast.makeText(getApplication(), "暫無相關內容", 0).show();
						e.printStackTrace();
					}
...
private void initListView() {
       ...
       mLv1.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent,
				...
				Intent intent =new Intent(getApplication(), TuiDetailActivity.class);
...
class  Myadapter extends   BaseAdapter{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Holder holder = null;
		if(convertView==null){
			convertView = LayoutInflater.from(getApplication())
