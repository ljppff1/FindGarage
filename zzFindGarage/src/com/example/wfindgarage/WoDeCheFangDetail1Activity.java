...
public class WoDeCheFangDetail1Activity extends FragmentActivity {
	...
	private ArrayList<Data> mDataList_origin=new ArrayList<WoDeCheFangDetail1Activity.Data>();
	private ArrayList<Data> mDataList=new ArrayList<WoDeCheFangDetail1Activity.Data>();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.wodechefangdetail1);
...
class  Myadapter extends   BaseAdapter{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Holder holder = null;
		if(convertView==null){
			convertView = LayoutInflater.from(WoDeCheFangDetail1Activity.this)
