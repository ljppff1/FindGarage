...
public class WoDeShouCangActivity extends BaseActivity {
	...
	private ArrayList<Data> mDataList_origin=new ArrayList<WoDeShouCangActivity.Data>();
	private ArrayList<Data> mDataList=new ArrayList<WoDeShouCangActivity.Data>();
						 ...
						 if (num_code==1) {
							 ...
							 JSONArray array = jsonObject.getJSONArray("data");
							  for (int i = 0; i < array.length(); i++) {
								 ...
								 data.StreetName = jsonObject2.getString("GarageRemark");
